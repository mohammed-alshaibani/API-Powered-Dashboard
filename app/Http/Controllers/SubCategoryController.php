...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.Admin.Subcategory.Index', compact('subcategories','categories'));
    }
    ...
    {
        $categories = Category::all();
        return view('dashboard.Admin.Subcategory.Create',compact('categories'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categories = Category::all();
        return view('dashboard.Admin.Subcategory.Edit', compact('subcategories','categories'));
    }
    ...
    public function MainPage(){
        return view('dashboard.User.Header');
    }
